...
def test_chain():
    chain = ComboCampaignHandler(Campaign("1234", "test", "combo;1|2;50"))
...
def test_chain_with_overlap():
    campaign = ComboCampaignHandler(Campaign("1234", "test","combo;1|2;50"))
    campaign = DiscountCampaignHandler(Campaign("12345","test","discount;1;50"), campaign)
